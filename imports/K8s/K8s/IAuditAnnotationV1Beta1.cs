...
namespace K8s
{
    ...
    /// <remarks>
    /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.AuditAnnotation
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IAuditAnnotationV1Beta1), fullyQualifiedName: "k8s.AuditAnnotationV1Beta1")]
    public interface IAuditAnnotationV1Beta1
    {
        ...
        /// Required.
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.AuditAnnotation#key
        /// </remarks>
        ...
        /// Required.
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.AuditAnnotation#valueExpression
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.AuditAnnotation
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IAuditAnnotationV1Beta1), fullyQualifiedName: "k8s.AuditAnnotationV1Beta1")]
        internal sealed class _Proxy : DeputyBase, K8s.IAuditAnnotationV1Beta1
        {
