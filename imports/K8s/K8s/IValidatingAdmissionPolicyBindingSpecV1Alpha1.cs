...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IValidatingAdmissionPolicyBindingSpecV1Alpha1), fullyQualifiedName: "k8s.ValidatingAdmissionPolicyBindingSpecV1Alpha1")]
    public interface IValidatingAdmissionPolicyBindingSpecV1Alpha1
    {
        ...
        K8s.IMatchResourcesV1Alpha1? MatchResources
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IParamRefV1Alpha1? ParamRef
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyBindingSpec
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IValidatingAdmissionPolicyBindingSpecV1Alpha1), fullyQualifiedName: "k8s.ValidatingAdmissionPolicyBindingSpecV1Alpha1")]
        internal sealed class _Proxy : DeputyBase, K8s.IValidatingAdmissionPolicyBindingSpecV1Alpha1
        {
            ...
            {
                get => GetInstanceProperty<K8s.IParamRefV1Alpha1?>();
            }
