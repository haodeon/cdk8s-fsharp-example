...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IEphemeralContainer), fullyQualifiedName: "k8s.EphemeralContainer")]
    public interface IEphemeralContainer
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.core.v1.EphemeralContainer
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IEphemeralContainer), fullyQualifiedName: "k8s.EphemeralContainer")]
        internal sealed class _Proxy : DeputyBase, K8s.IEphemeralContainer
        {
