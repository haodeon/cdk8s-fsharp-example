...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IPodSpec), fullyQualifiedName: "k8s.PodSpec")]
    public interface IPodSpec
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IEphemeralContainer[]? EphemeralContainers
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        System.Collections.Generic.IDictionary<string, K8s.Quantity>? Overhead
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IPodReadinessGate[]? ReadinessGates
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IPodResourceClaim[]? ResourceClaims
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IPodSchedulingGate[]? SchedulingGates
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IPodSecurityContext? SecurityContext
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.ITopologySpreadConstraint[]? TopologySpreadConstraints
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.core.v1.PodSpec
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IPodSpec), fullyQualifiedName: "k8s.PodSpec")]
        internal sealed class _Proxy : DeputyBase, K8s.IPodSpec
        {
            ...
            {
                get => GetInstanceProperty<K8s.IContainer[]>()!;
            }
            ...
            {
                get => GetInstanceProperty<K8s.IAffinity?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IPodDnsConfig?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IEphemeralContainer[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IHostAlias[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IPodOs?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IPodReadinessGate[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IPodResourceClaim[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IPodSchedulingGate[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IPodSecurityContext?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.ITopologySpreadConstraint[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IVolume[]?>();
            }
        }
    }
}
