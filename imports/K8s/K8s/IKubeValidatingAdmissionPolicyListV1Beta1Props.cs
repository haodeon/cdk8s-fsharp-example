...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IKubeValidatingAdmissionPolicyListV1Beta1Props), fullyQualifiedName: "k8s.KubeValidatingAdmissionPolicyListV1Beta1Props")]
    public interface IKubeValidatingAdmissionPolicyListV1Beta1Props
    {
        ...
        K8s.IKubeValidatingAdmissionPolicyV1Beta1Props[]? Items
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyList
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IKubeValidatingAdmissionPolicyListV1Beta1Props), fullyQualifiedName: "k8s.KubeValidatingAdmissionPolicyListV1Beta1Props")]
        internal sealed class _Proxy : DeputyBase, K8s.IKubeValidatingAdmissionPolicyListV1Beta1Props
        {
            ...
            {
                get => GetInstanceProperty<K8s.IKubeValidatingAdmissionPolicyV1Beta1Props[]?>();
            }
