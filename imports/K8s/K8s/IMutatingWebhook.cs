...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IMutatingWebhook), fullyQualifiedName: "k8s.MutatingWebhook")]
    public interface IMutatingWebhook
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.MutatingWebhook
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IMutatingWebhook), fullyQualifiedName: "k8s.MutatingWebhook")]
        internal sealed class _Proxy : DeputyBase, K8s.IMutatingWebhook
        {
