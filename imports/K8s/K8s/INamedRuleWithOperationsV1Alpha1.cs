...
namespace K8s
{
    ...
    /// <remarks>
    /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.NamedRuleWithOperations
    /// </remarks>
    [JsiiInterface(nativeType: typeof(INamedRuleWithOperationsV1Alpha1), fullyQualifiedName: "k8s.NamedRuleWithOperationsV1Alpha1")]
    public interface INamedRuleWithOperationsV1Alpha1
    {
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.NamedRuleWithOperations#apiGroups
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.NamedRuleWithOperations#apiVersions
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.NamedRuleWithOperations#operations
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.NamedRuleWithOperations#resourceNames
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.NamedRuleWithOperations#resources
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.NamedRuleWithOperations#scope
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.NamedRuleWithOperations
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(INamedRuleWithOperationsV1Alpha1), fullyQualifiedName: "k8s.NamedRuleWithOperationsV1Alpha1")]
        internal sealed class _Proxy : DeputyBase, K8s.INamedRuleWithOperationsV1Alpha1
        {
