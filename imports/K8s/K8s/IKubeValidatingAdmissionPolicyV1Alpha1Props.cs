...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IKubeValidatingAdmissionPolicyV1Alpha1Props), fullyQualifiedName: "k8s.KubeValidatingAdmissionPolicyV1Alpha1Props")]
    public interface IKubeValidatingAdmissionPolicyV1Alpha1Props
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IValidatingAdmissionPolicySpecV1Alpha1? Spec
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicy
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IKubeValidatingAdmissionPolicyV1Alpha1Props), fullyQualifiedName: "k8s.KubeValidatingAdmissionPolicyV1Alpha1Props")]
        internal sealed class _Proxy : DeputyBase, K8s.IKubeValidatingAdmissionPolicyV1Alpha1Props
        {
            ...
            {
                get => GetInstanceProperty<K8s.IValidatingAdmissionPolicySpecV1Alpha1?>();
            }
        }
    }
}
