...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IParamKindV1Alpha1), fullyQualifiedName: "k8s.ParamKindV1Alpha1")]
    public interface IParamKindV1Alpha1
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.ParamKind
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IParamKindV1Alpha1), fullyQualifiedName: "k8s.ParamKindV1Alpha1")]
        internal sealed class _Proxy : DeputyBase, K8s.IParamKindV1Alpha1
        {
