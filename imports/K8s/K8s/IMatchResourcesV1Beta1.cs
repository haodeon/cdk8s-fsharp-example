...
namespace K8s
{
    ...
    ///
    /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.MatchResources
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IMatchResourcesV1Beta1), fullyQualifiedName: "k8s.MatchResourcesV1Beta1")]
    public interface IMatchResourcesV1Beta1
    {
        ...
        /// The exclude rules take precedence over include rules (if a resource matches both, it is excluded)
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.MatchResources#excludeResourceRules
        /// </remarks>
        [JsiiProperty(name: "excludeResourceRules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"k8s.NamedRuleWithOperationsV1Beta1\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.INamedRuleWithOperationsV1Beta1[]? ExcludeResourceRules
        {
            get
            {
                return null;
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.MatchResources#matchPolicy
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.MatchResources#namespaceSelector
        /// </remarks>
        ...
        /// <strong>Default</strong>: the empty LabelSelector, which matches everything.
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.MatchResources#objectSelector
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.MatchResources#resourceRules
        /// </remarks>
        [JsiiProperty(name: "resourceRules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"k8s.NamedRuleWithOperationsV1Beta1\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.INamedRuleWithOperationsV1Beta1[]? ResourceRules
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.MatchResources
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IMatchResourcesV1Beta1), fullyQualifiedName: "k8s.MatchResourcesV1Beta1")]
        internal sealed class _Proxy : DeputyBase, K8s.IMatchResourcesV1Beta1
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "excludeResourceRules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"k8s.NamedRuleWithOperationsV1Beta1\"},\"kind\":\"array\"}}", isOptional: true)]
            public K8s.INamedRuleWithOperationsV1Beta1[]? ExcludeResourceRules
            {
                get => GetInstanceProperty<K8s.INamedRuleWithOperationsV1Beta1[]?>();
            }
            ...
            [JsiiOptional]
            [JsiiProperty(name: "resourceRules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"k8s.NamedRuleWithOperationsV1Beta1\"},\"kind\":\"array\"}}", isOptional: true)]
            public K8s.INamedRuleWithOperationsV1Beta1[]? ResourceRules
            {
                get => GetInstanceProperty<K8s.INamedRuleWithOperationsV1Beta1[]?>();
            }
        }
