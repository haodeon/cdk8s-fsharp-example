...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IExemptPriorityLevelConfigurationV1Beta3), fullyQualifiedName: "k8s.ExemptPriorityLevelConfigurationV1Beta3")]
    public interface IExemptPriorityLevelConfigurationV1Beta3
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1beta3.ExemptPriorityLevelConfiguration
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IExemptPriorityLevelConfigurationV1Beta3), fullyQualifiedName: "k8s.ExemptPriorityLevelConfigurationV1Beta3")]
        internal sealed class _Proxy : DeputyBase, K8s.IExemptPriorityLevelConfigurationV1Beta3
        {
