...
namespace K8s
{
    ...
    /// <remarks>
    /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ParamRef
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IParamRef), fullyQualifiedName: "k8s.ParamRef")]
    public interface IParamRef
    {
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ParamRef#name
        /// </remarks>
        ...
        /// </list>
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ParamRef#namespace
        /// </remarks>
        ...
        /// Required
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ParamRef#parameterNotFoundAction
        /// </remarks>
        ...
        /// One of <c>name</c> or <c>selector</c> must be set, but <c>name</c> and <c>selector</c> are mutually exclusive properties. If one is set, the other must be unset.
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ParamRef#selector
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ParamRef
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IParamRef), fullyQualifiedName: "k8s.ParamRef")]
        internal sealed class _Proxy : DeputyBase, K8s.IParamRef
        {
