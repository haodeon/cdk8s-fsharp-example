...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IKubeCsiDriverProps), fullyQualifiedName: "k8s.KubeCsiDriverProps")]
    public interface IKubeCsiDriverProps
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.storage.v1.CSIDriver
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IKubeCsiDriverProps), fullyQualifiedName: "k8s.KubeCsiDriverProps")]
        internal sealed class _Proxy : DeputyBase, K8s.IKubeCsiDriverProps
        {
            ...
            {
                get => GetInstanceProperty<K8s.ICsiDriverSpec>()!;
            }
