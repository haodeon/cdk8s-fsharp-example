...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IValidatingAdmissionPolicySpec), fullyQualifiedName: "k8s.ValidatingAdmissionPolicySpec")]
    public interface IValidatingAdmissionPolicySpec
    {
        ...
        K8s.IAuditAnnotation[]? AuditAnnotations
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IMatchResources? MatchConstraints
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IValidatingAdmissionPolicySpec), fullyQualifiedName: "k8s.ValidatingAdmissionPolicySpec")]
        internal sealed class _Proxy : DeputyBase, K8s.IValidatingAdmissionPolicySpec
        {
            ...
            {
                get => GetInstanceProperty<K8s.IAuditAnnotation[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IParamKind?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IValidation[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IVariable[]?>();
            }
        }
    }
}
