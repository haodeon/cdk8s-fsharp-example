...
namespace K8s
{
    ...
    /// <remarks>
    /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.QueuingConfiguration
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IQueuingConfiguration), fullyQualifiedName: "k8s.QueuingConfiguration")]
    public interface IQueuingConfiguration
    {
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.QueuingConfiguration#handSize
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.QueuingConfiguration#queueLengthLimit
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.QueuingConfiguration#queues
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.QueuingConfiguration
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IQueuingConfiguration), fullyQualifiedName: "k8s.QueuingConfiguration")]
        internal sealed class _Proxy : DeputyBase, K8s.IQueuingConfiguration
        {
