...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IKubeValidatingAdmissionPolicyBindingV1Beta1Props), fullyQualifiedName: "k8s.KubeValidatingAdmissionPolicyBindingV1Beta1Props")]
    public interface IKubeValidatingAdmissionPolicyBindingV1Beta1Props
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IValidatingAdmissionPolicyBindingSpecV1Beta1? Spec
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyBinding
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IKubeValidatingAdmissionPolicyBindingV1Beta1Props), fullyQualifiedName: "k8s.KubeValidatingAdmissionPolicyBindingV1Beta1Props")]
        internal sealed class _Proxy : DeputyBase, K8s.IKubeValidatingAdmissionPolicyBindingV1Beta1Props
        {
            ...
            {
                get => GetInstanceProperty<K8s.IValidatingAdmissionPolicyBindingSpecV1Beta1?>();
            }
        }
    }
}
