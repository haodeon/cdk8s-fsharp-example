...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IMatchConditionV1Alpha1), fullyQualifiedName: "k8s.MatchConditionV1Alpha1")]
    public interface IMatchConditionV1Alpha1
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.MatchCondition
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IMatchConditionV1Alpha1), fullyQualifiedName: "k8s.MatchConditionV1Alpha1")]
        internal sealed class _Proxy : DeputyBase, K8s.IMatchConditionV1Alpha1
        {
