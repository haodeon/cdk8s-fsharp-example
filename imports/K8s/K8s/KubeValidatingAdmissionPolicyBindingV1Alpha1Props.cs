...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "k8s.KubeValidatingAdmissionPolicyBindingV1Alpha1Props")]
    public class KubeValidatingAdmissionPolicyBindingV1Alpha1Props : K8s.IKubeValidatingAdmissionPolicyBindingV1Alpha1Props
    {
