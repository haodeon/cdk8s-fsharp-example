...
namespace K8s
{
    ...
    ///
    /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1beta3.NonResourcePolicyRule
    /// </remarks>
    [JsiiInterface(nativeType: typeof(INonResourcePolicyRuleV1Beta3), fullyQualifiedName: "k8s.NonResourcePolicyRuleV1Beta3")]
    public interface INonResourcePolicyRuleV1Beta3
    {
        ...
        /// </list>
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1beta3.NonResourcePolicyRule#nonResourceURLs
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1beta3.NonResourcePolicyRule#verbs
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1beta3.NonResourcePolicyRule
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(INonResourcePolicyRuleV1Beta3), fullyQualifiedName: "k8s.NonResourcePolicyRuleV1Beta3")]
        internal sealed class _Proxy : DeputyBase, K8s.INonResourcePolicyRuleV1Beta3
        {
