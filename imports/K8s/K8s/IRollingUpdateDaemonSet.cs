...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IRollingUpdateDaemonSet), fullyQualifiedName: "k8s.RollingUpdateDaemonSet")]
    public interface IRollingUpdateDaemonSet
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.apps.v1.RollingUpdateDaemonSet
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IRollingUpdateDaemonSet), fullyQualifiedName: "k8s.RollingUpdateDaemonSet")]
        internal sealed class _Proxy : DeputyBase, K8s.IRollingUpdateDaemonSet
        {
