...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "k8s.LimitedPriorityLevelConfigurationV1Beta3")]
    public class LimitedPriorityLevelConfigurationV1Beta3 : K8s.ILimitedPriorityLevelConfigurationV1Beta3
    {
