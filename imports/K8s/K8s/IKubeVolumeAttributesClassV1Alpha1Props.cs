...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IKubeVolumeAttributesClassV1Alpha1Props), fullyQualifiedName: "k8s.KubeVolumeAttributesClassV1Alpha1Props")]
    public interface IKubeVolumeAttributesClassV1Alpha1Props
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.storage.v1alpha1.VolumeAttributesClass
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IKubeVolumeAttributesClassV1Alpha1Props), fullyQualifiedName: "k8s.KubeVolumeAttributesClassV1Alpha1Props")]
        internal sealed class _Proxy : DeputyBase, K8s.IKubeVolumeAttributesClassV1Alpha1Props
        {
