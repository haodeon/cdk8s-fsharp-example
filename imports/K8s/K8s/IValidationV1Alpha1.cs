...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IValidationV1Alpha1), fullyQualifiedName: "k8s.ValidationV1Alpha1")]
    public interface IValidationV1Alpha1
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1alpha1.Validation
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IValidationV1Alpha1), fullyQualifiedName: "k8s.ValidationV1Alpha1")]
        internal sealed class _Proxy : DeputyBase, K8s.IValidationV1Alpha1
        {
