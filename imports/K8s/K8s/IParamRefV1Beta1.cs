...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IParamRefV1Beta1), fullyQualifiedName: "k8s.ParamRefV1Beta1")]
    public interface IParamRefV1Beta1
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.ParamRef
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IParamRefV1Beta1), fullyQualifiedName: "k8s.ParamRefV1Beta1")]
        internal sealed class _Proxy : DeputyBase, K8s.IParamRefV1Beta1
        {
