...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "k8s.ValidatingAdmissionPolicyBindingSpecV1Beta1")]
    public class ValidatingAdmissionPolicyBindingSpecV1Beta1 : K8s.IValidatingAdmissionPolicyBindingSpecV1Beta1
    {
