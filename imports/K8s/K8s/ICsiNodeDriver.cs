...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(ICsiNodeDriver), fullyQualifiedName: "k8s.CsiNodeDriver")]
    public interface ICsiNodeDriver
    {
        ...
        K8s.IVolumeNodeResources? Allocatable
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.storage.v1.CSINodeDriver
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(ICsiNodeDriver), fullyQualifiedName: "k8s.CsiNodeDriver")]
        internal sealed class _Proxy : DeputyBase, K8s.ICsiNodeDriver
        {
            ...
            {
                get => GetInstanceProperty<K8s.IVolumeNodeResources?>();
            }
