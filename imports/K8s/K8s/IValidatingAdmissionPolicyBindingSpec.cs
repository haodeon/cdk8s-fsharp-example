...
namespace K8s
{
    ...
    /// <remarks>
    /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IValidatingAdmissionPolicyBindingSpec), fullyQualifiedName: "k8s.ValidatingAdmissionPolicyBindingSpec")]
    public interface IValidatingAdmissionPolicyBindingSpec
    {
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec#matchResources
        /// </remarks>
        [JsiiProperty(name: "matchResources", typeJson: "{\"fqn\":\"k8s.MatchResources\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IMatchResources? MatchResources
        {
            get
            {
                return null;
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec#paramRef
        /// </remarks>
        [JsiiProperty(name: "paramRef", typeJson: "{\"fqn\":\"k8s.ParamRef\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IParamRef? ParamRef
        {
            get
            {
                return null;
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec#policyName
        /// </remarks>
        ...
        /// Required.
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec#validationActions
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyBindingSpec
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IValidatingAdmissionPolicyBindingSpec), fullyQualifiedName: "k8s.ValidatingAdmissionPolicyBindingSpec")]
        internal sealed class _Proxy : DeputyBase, K8s.IValidatingAdmissionPolicyBindingSpec
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "matchResources", typeJson: "{\"fqn\":\"k8s.MatchResources\"}", isOptional: true)]
            public K8s.IMatchResources? MatchResources
            {
                get => GetInstanceProperty<K8s.IMatchResources?>();
            }
            ...
            [JsiiOptional]
            [JsiiProperty(name: "paramRef", typeJson: "{\"fqn\":\"k8s.ParamRef\"}", isOptional: true)]
            public K8s.IParamRef? ParamRef
            {
                get => GetInstanceProperty<K8s.IParamRef?>();
            }
