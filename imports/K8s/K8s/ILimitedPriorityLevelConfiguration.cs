...
namespace K8s
{
    ...
    /// </list>
    ///
    /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration
    /// </remarks>
    [JsiiInterface(nativeType: typeof(ILimitedPriorityLevelConfiguration), fullyQualifiedName: "k8s.LimitedPriorityLevelConfiguration")]
    public interface ILimitedPriorityLevelConfiguration
    {
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration#borrowingLimitPercent
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration#lendablePercent
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration#limitResponse
        /// </remarks>
        [JsiiProperty(name: "limitResponse", typeJson: "{\"fqn\":\"k8s.LimitResponse\"}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.ILimitResponse? LimitResponse
        {
            get
            {
                return null;
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration#nominalConcurrencyShares
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.LimitedPriorityLevelConfiguration
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(ILimitedPriorityLevelConfiguration), fullyQualifiedName: "k8s.LimitedPriorityLevelConfiguration")]
        internal sealed class _Proxy : DeputyBase, K8s.ILimitedPriorityLevelConfiguration
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "limitResponse", typeJson: "{\"fqn\":\"k8s.LimitResponse\"}", isOptional: true)]
            public K8s.ILimitResponse? LimitResponse
            {
                get => GetInstanceProperty<K8s.ILimitResponse?>();
            }
