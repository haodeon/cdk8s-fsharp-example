...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(ICsiDriverSpec), fullyQualifiedName: "k8s.CsiDriverSpec")]
    public interface ICsiDriverSpec
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.ITokenRequest[]? TokenRequests
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.storage.v1.CSIDriverSpec
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(ICsiDriverSpec), fullyQualifiedName: "k8s.CsiDriverSpec")]
        internal sealed class _Proxy : DeputyBase, K8s.ICsiDriverSpec
        {
            ...
            {
                get => GetInstanceProperty<K8s.ITokenRequest[]?>();
            }
