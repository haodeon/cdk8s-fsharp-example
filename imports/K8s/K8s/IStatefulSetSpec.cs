...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IStatefulSetSpec), fullyQualifiedName: "k8s.StatefulSetSpec")]
    public interface IStatefulSetSpec
    {
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IStatefulSetOrdinals? Ordinals
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IStatefulSetPersistentVolumeClaimRetentionPolicy? PersistentVolumeClaimRetentionPolicy
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IStatefulSetUpdateStrategy? UpdateStrategy
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.IKubePersistentVolumeClaimProps[]? VolumeClaimTemplates
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.apps.v1.StatefulSetSpec
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IStatefulSetSpec), fullyQualifiedName: "k8s.StatefulSetSpec")]
        internal sealed class _Proxy : DeputyBase, K8s.IStatefulSetSpec
        {
            ...
            {
                get => GetInstanceProperty<K8s.IStatefulSetOrdinals?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IStatefulSetPersistentVolumeClaimRetentionPolicy?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.IStatefulSetUpdateStrategy?>();
            }
