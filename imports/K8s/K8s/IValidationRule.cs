...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IValidationRule), fullyQualifiedName: "k8s.ValidationRule")]
    public interface IValidationRule
    {
        ...
        /// <strong>Schema</strong>: io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.ValidationRule
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IValidationRule), fullyQualifiedName: "k8s.ValidationRule")]
        internal sealed class _Proxy : DeputyBase, K8s.IValidationRule
        {
