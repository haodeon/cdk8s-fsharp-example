...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IResourceClaimTemplateSpecV1Alpha2), fullyQualifiedName: "k8s.ResourceClaimTemplateSpecV1Alpha2")]
    public interface IResourceClaimTemplateSpecV1Alpha2
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.resource.v1alpha2.ResourceClaimTemplateSpec
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IResourceClaimTemplateSpecV1Alpha2), fullyQualifiedName: "k8s.ResourceClaimTemplateSpecV1Alpha2")]
        internal sealed class _Proxy : DeputyBase, K8s.IResourceClaimTemplateSpecV1Alpha2
        {
