...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IMatchCondition), fullyQualifiedName: "k8s.MatchCondition")]
    public interface IMatchCondition
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.MatchCondition
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IMatchCondition), fullyQualifiedName: "k8s.MatchCondition")]
        internal sealed class _Proxy : DeputyBase, K8s.IMatchCondition
        {
