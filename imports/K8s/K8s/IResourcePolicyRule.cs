...
namespace K8s
{
    ...
    ///
    /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.ResourcePolicyRule
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IResourcePolicyRule), fullyQualifiedName: "k8s.ResourcePolicyRule")]
    public interface IResourcePolicyRule
    {
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.ResourcePolicyRule#apiGroups
        /// </remarks>
        ...
        /// <remarks>
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.ResourcePolicyRule#resources
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.ResourcePolicyRule#verbs
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.ResourcePolicyRule#clusterScope
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.ResourcePolicyRule#namespaces
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.flowcontrol.v1.ResourcePolicyRule
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IResourcePolicyRule), fullyQualifiedName: "k8s.ResourcePolicyRule")]
        internal sealed class _Proxy : DeputyBase, K8s.IResourcePolicyRule
        {
