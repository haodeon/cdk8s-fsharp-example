...
namespace K8s
{
    ...
    /// <remarks>
    /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.AuditAnnotation
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IAuditAnnotation), fullyQualifiedName: "k8s.AuditAnnotation")]
    public interface IAuditAnnotation
    {
        ...
        /// Required.
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.AuditAnnotation#key
        /// </remarks>
        ...
        /// Required.
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.AuditAnnotation#valueExpression
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.AuditAnnotation
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IAuditAnnotation), fullyQualifiedName: "k8s.AuditAnnotation")]
        internal sealed class _Proxy : DeputyBase, K8s.IAuditAnnotation
        {
