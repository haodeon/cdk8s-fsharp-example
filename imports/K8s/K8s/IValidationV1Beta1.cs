...
namespace K8s
{
    ...
    /// <remarks>
    /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.Validation
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IValidationV1Beta1), fullyQualifiedName: "k8s.ValidationV1Beta1")]
    public interface IValidationV1Beta1
    {
        ...
        /// </list>
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.Validation#expression
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.Validation#message
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.Validation#messageExpression
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.Validation#reason
        /// </remarks>
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1beta1.Validation
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IValidationV1Beta1), fullyQualifiedName: "k8s.ValidationV1Beta1")]
        internal sealed class _Proxy : DeputyBase, K8s.IValidationV1Beta1
        {
