...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IKubeSelfSubjectReviewV1Beta1Props), fullyQualifiedName: "k8s.KubeSelfSubjectReviewV1Beta1Props")]
    public interface IKubeSelfSubjectReviewV1Beta1Props
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.authentication.v1beta1.SelfSubjectReview
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IKubeSelfSubjectReviewV1Beta1Props), fullyQualifiedName: "k8s.KubeSelfSubjectReviewV1Beta1Props")]
        internal sealed class _Proxy : DeputyBase, K8s.IKubeSelfSubjectReviewV1Beta1Props
        {
