...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "k8s.ValidatingAdmissionPolicySpecV1Alpha1")]
    public class ValidatingAdmissionPolicySpecV1Alpha1 : K8s.IValidatingAdmissionPolicySpecV1Alpha1
    {
