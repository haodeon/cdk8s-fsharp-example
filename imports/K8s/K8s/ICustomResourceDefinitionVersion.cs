...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(ICustomResourceDefinitionVersion), fullyQualifiedName: "k8s.CustomResourceDefinitionVersion")]
    public interface ICustomResourceDefinitionVersion
    {
        ...
        K8s.ICustomResourceColumnDefinition[]? AdditionalPrinterColumns
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.ICustomResourceValidation? Schema
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.ISelectableField[]? SelectableFields
        {
            get
            {
                return null;
        ...
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.ICustomResourceSubresources? Subresources
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.CustomResourceDefinitionVersion
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(ICustomResourceDefinitionVersion), fullyQualifiedName: "k8s.CustomResourceDefinitionVersion")]
        internal sealed class _Proxy : DeputyBase, K8s.ICustomResourceDefinitionVersion
        {
            ...
            {
                get => GetInstanceProperty<K8s.ICustomResourceColumnDefinition[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.ICustomResourceValidation?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.ISelectableField[]?>();
            }
            ...
            {
                get => GetInstanceProperty<K8s.ICustomResourceSubresources?>();
            }
        }
    }
}
