...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "k8s.PodFailurePolicyOnExitCodesRequirement")]
    public class PodFailurePolicyOnExitCodesRequirement : K8s.IPodFailurePolicyOnExitCodesRequirement
    {
