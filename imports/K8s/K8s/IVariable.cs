...
namespace K8s
{
    ...
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IVariable), fullyQualifiedName: "k8s.Variable")]
    public interface IVariable
    {
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.Variable
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IVariable), fullyQualifiedName: "k8s.Variable")]
        internal sealed class _Proxy : DeputyBase, K8s.IVariable
        {
