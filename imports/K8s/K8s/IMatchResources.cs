...
namespace K8s
{
    ...
    ///
    /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.MatchResources
    /// </remarks>
    [JsiiInterface(nativeType: typeof(IMatchResources), fullyQualifiedName: "k8s.MatchResources")]
    public interface IMatchResources
    {
        ...
        /// The exclude rules take precedence over include rules (if a resource matches both, it is excluded)
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.MatchResources#excludeResourceRules
        /// </remarks>
        [JsiiProperty(name: "excludeResourceRules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"k8s.NamedRuleWithOperations\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.INamedRuleWithOperations[]? ExcludeResourceRules
        {
            get
            {
                return null;
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.MatchResources#matchPolicy
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.MatchResources#namespaceSelector
        /// </remarks>
        ...
        /// <strong>Default</strong>: the empty LabelSelector, which matches everything.
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.MatchResources#objectSelector
        /// </remarks>
        ...
        ///
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.MatchResources#resourceRules
        /// </remarks>
        [JsiiProperty(name: "resourceRules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"k8s.NamedRuleWithOperations\"},\"kind\":\"array\"}}", isOptional: true)]
        [Amazon.JSII.Runtime.Deputy.JsiiOptional]
        K8s.INamedRuleWithOperations[]? ResourceRules
        {
            get
            {
                return null;
        ...
        /// <strong>Schema</strong>: io.k8s.api.admissionregistration.v1.MatchResources
        /// </remarks>
        [JsiiTypeProxy(nativeType: typeof(IMatchResources), fullyQualifiedName: "k8s.MatchResources")]
        internal sealed class _Proxy : DeputyBase, K8s.IMatchResources
        {
            ...
            [JsiiOptional]
            [JsiiProperty(name: "excludeResourceRules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"k8s.NamedRuleWithOperations\"},\"kind\":\"array\"}}", isOptional: true)]
            public K8s.INamedRuleWithOperations[]? ExcludeResourceRules
            {
                get => GetInstanceProperty<K8s.INamedRuleWithOperations[]?>();
            }
            ...
            [JsiiOptional]
            [JsiiProperty(name: "resourceRules", typeJson: "{\"collection\":{\"elementtype\":{\"fqn\":\"k8s.NamedRuleWithOperations\"},\"kind\":\"array\"}}", isOptional: true)]
            public K8s.INamedRuleWithOperations[]? ResourceRules
            {
                get => GetInstanceProperty<K8s.INamedRuleWithOperations[]?>();
            }
        }
